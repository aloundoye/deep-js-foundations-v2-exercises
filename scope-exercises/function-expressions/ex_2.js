function printRecords(recordIds) {
	// TODO
	 var currentStudents = studentRecords.filter((student) => (
		Array.isArray(recordIds) && recordIds.includes(student.id)
	 ));
...
function paidStudentsToEnroll() {
	...
	var paidStudentsNotEnrolled = studentRecords.filter((student) => {
...
function remindUnpaid(recordIds) {
	...
	var unpaidStudents = studentRecords.filter((student)=> {
		return !student.paid && Array.isArray(currentEnrollment) && currentEnrollment.includes(student.id);
